      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: _widthHeight.screenHeight(context, 0.01)),
                      const Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Ahmad",
                        ...
                        children: [
                          Padding(
                            ...
                            child: Container(
                                ...
                                child: Image.network(widget.product.image!.toString(), fit: BoxFit.fill,)),
                          ),
                          Positioned(
            ...
            SizedBox(height: _widthHeight.screenHeight(context, 0.010)),
            ConstrainedBox(
              constraints: BoxConstraints.expand(height: _widthHeight.screenHeight(context, 0.17)),
              child: Container(
            ...
            const CategoriesListTile(title: "Shipping and Delivery", imageAsset: "")
          ]),
        ),
      ),
    );
